...
def main():
    ...
    if args.refund:
        ...
        result = job_ops.claim_refund(job_id=job_id)
    ...
    if args.dispute:
        ...
        result = job_ops.dispute(job_id=job_id)
    ...
    if status != "SUBMITTED":
        ...
        if status == "FUNDED":
            print("[settle] Provider hasn't submitted yet. Wait or run 03_provider.py.")
        sys.exit(1)
    ...
    result = job_ops.settle(job_id=job_id)
